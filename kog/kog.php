            	...
            	<div class="row">
		            ...
		            <div class="col-md-4">
		              <div class="form-group">
		                ...
		                <input name="rebuy_rate" type="text" class="form-control" id="example3cols2Input" placeholder="One of three cols" value=<?php _e(isset($_REQUEST['rebuy_rate'])?$_REQUEST['rebuy_rate']:'300')?>>
		              </div>
		            </div>
		            <div class="col-md-4">
		              <div class="form-group">
		            ...
		            <div class="col-md-4">
		              <div class="form-group">
		                <label class="form-control-label" for="example3cols2Input">Small Blind</label>
		                <input name="small_blind" type="text" class="form-control" id="example3cols2Input" placeholder="One of three cols" value=<?php _e(isset($_REQUEST['small_blind'])?$_REQUEST['small_blind']:'5')?>>
		              </div>
		            </div>
		            <div class="col-md-4">
		              <div class="form-group">
		                <label class="form-control-label" for="example3cols2Input">Big Blind</label>
		                <input name="big_blind" type="text" class="form-control" id="example3cols2Input" placeholder="One of three cols" value=<?php _e(isset($_REQUEST['big_blind'])?$_REQUEST['big_blind']:'10')?>>
		              </div>
		            </div>
		            <div class="col-md-4">
		              <div class="form-group">
		                <label class="form-control-label" for="example3cols2Input">Straddle</label>
		                <input name="straddle" type="text" class="form-control" id="example3cols2Input" placeholder="One of three cols" value=<?php _e(isset($_REQUEST['straddle'])?$_REQUEST['straddle']:'0')?>>
		              </div>
		            </div>
		          </div>
            </div>
