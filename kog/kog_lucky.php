...
if (isset($game_player_select_array)) {
	$game_player_json = serialize($game_player_select_array);
}
	...
	<div class="container-fluid mt--6">
		...
		<div class="col-lg-12 card-wrapper ct-example">
			<div class="form-group row" style="margin-bottom: 1rem">
				<label for="example-password-input" class="col-md-2 col-form-label form-control-label">Dealer</label>
			...
			<div class="form-group row" >
				<label for="example-password-input" class="col-md-2 col-form-label form-control-label">Lucky Type</label>
			...
			<div class="form-group row" style="margin-bottom: 1rem">
				<label for="example-password-input" class="col-md-2 col-form-label form-control-label">Cards</label>
			...
			<div class="form-group row" style="margin-bottom: 1rem">
				<label for="example-password-input" class="col-md-2 col-form-label form-control-label">Bonus</label>
			...
			<div style="text-align: center;padding-top: 10px">
				...
				<input type="hidden" name="player" value='<?php _e($game_player_json)?>'>
				<!-- <input type="submit" value="Rebuy!" class="btn btn-primary btn-lg btn-block" > -->
				<button type="submit" class="btn btn-primary btn-lg btn-block">Lucky</button>
			</div>
	            </div>
	        </div>
    	</div>
