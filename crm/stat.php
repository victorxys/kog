...
<body>
    ...
    padding-right: 10px;">
      				<div class="col-3 col-md-3"><a style="color: #ffffff" href="?type=total&y=<?php _e($this_year)?>">概况统计</a></div>
      				<div class="col-3 col-md-3"><a style="color: #ffffff" href="?type=detail&y=<?php _e($this_year)?>">详情展示</a></div>
      				<div class="col-3 col-md-3"><a style="color: #ffffff" href="?type=killrank&y=<?php _e($this_year)?>">清台榜</a></div>
      				<div class="col-3 col-md-3"><a style="color: #ffffff" href="?type=position&y=<?php _e($this_year)?>">方位盈亏</a></div>
      			</div>
	            ...
	            <!-- Card header -->
		            <div class="card-header">
			              <div class="row align-items-center">
				                <div class="col-7">
				                  <!-- Title -->
				                  <h5 class="h3 mb-0"><?php _e($time_zone.":".game_type_array($game_type))?></h5>
				                </div>
				            ...
				            <tbody>
									<?php foreach($winer_rate as $key => $value):?>
										...
										<tr>
											...
											<td class="tdtxt"><?php _e(floatval($value['gamecount']).'/'.$game_count)?></td>
		...
		<?php endif?>
				...
				<div class="row row-example">
					<div class="col text-center">
						<a class="btn btn-primary btn-sm" href="?type=total&y=2018&game_type=<?php _e($game_type)?>">全部数据</a>
					</div>
					<div class="col text-center">
						<a class="btn btn-primary btn-sm" href="?type=total&y=<?php _e(date('Y'))?>&game_type=<?php _e($game_type)?>">今年数据</a>
